...
<div class="flex justify-between ...">
  <h1>应用已部署模型完成预测</h1>
  <button class="border rounded border-teal-500 text-teal-500 block rounded-sm font-bold py-4 px-6 mr-2 flex items-center hover:bg-teal-500 hover:text-white" on:click={() => goto(`auto-pipeline/`)}>
