...
<div class="card w-full">
	<div class="card-body">
		<p>
			使用 NO TEARS 方法绘制出因果关系的 DAG 图。参考论文：DAGs with NO TEARS: Continuous
					...
					<div class="hero bg-base-200 h-96">
						...
						<div class="hero-content text-left text-neutral-content">
							<div class="max-w-md">
								...
								<p class="mb-5">
									不一定所有的特征变量之间都具有强因果关系，我们可以设置边系数阈值（0~1之间），而边系数大于该阈值的点与边则会出现在因果图中。
								</p>
						...
						<div class="px-4 mx-auto container align-middle">
							<div class="px-4 mx-auto container align-middle h-[32rem] mt-6">
								<div class="flex flex-row justify-center items-center">
									<img
										src="{baseLink}/static/data/{username}/images/causal/notears.png"
										alt="NOTEARS Figure"
										id="notears-image"
									/>
								</div>
