...
<div>
	...
	<div align="center">
		<div class="dis-bottom">
			<button type="submit" class="btn btn-info" on:click={ordinaryLeastSquares}>
				Ordinary Least Squares
			</button>
			<button type="submit" class="btn btn-success" on:click={getInalpha}>Ridge regression</button>
			<button class="btn btn-warning">Lasso</button>
			<button class="btn btn-error">Multi-task Lasso</button>
			<button type="submit" class="btn btn-info" on:click={boostedDecisionTreeRegression}
