<script>
    ...
    function train(){
      ...
      regressionTrainerApi(username, testPercent/100, 'lightgbm').then((response) => {
...
<h1>Regression Model: LightGBM</h1>

<div class="card w-full">
  <div class="card-body"> 
    <p>LigthGBM算法在训练过程中采用单边梯度算法(GOSS)过滤掉梯度小的样本,减少了大量的计算。</p>
  </div>
</div>
            ...
            <svelte:fragment slot="content">
              ...
              <TabContent>
                ...
                <div class="hero bg-base-200 h-96">
                  ...
                  <div class="hero-content text-left text-neutral-content">
                    <div class="max-w-md">
                      <h2 class="mb-5 text-5xl font-bold">Lightgbm</h2>
