<script>
  ...
  function train(){
    ...
    currentState = '训练中...'
    regressionTrainerApi(username, testPercent/100, 'svm').then((response) => {
...
<div class="card w-full">
  <div class="card-body"> 
    <p>支持向量机(SVM)是一类按监督学习方式对数据进行二元分类的广义线性分类器，其决策边界是对学习样本求解的最大边距超平面。</p>
  </div>
</div>
            ...
            <svelte:fragment slot="content">
              ...
              <TabContent>
                ...
                <div class="hero bg-base-200 h-96">
                  ...
                  <div class="hero-content text-left text-neutral-content">
                    <div class="max-w-md">
                      <h2 class="mb-5 text-5xl font-bold">SVM</h2>
