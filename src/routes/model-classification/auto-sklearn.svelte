<script>
    ...
    function train(){
      ...
      currentState = '训练中...'
      classificationTrainerApi(username, testPercent/100, 'auto_sklearn').then((response) => {
        if (response.status == 200) {
          ...
          image.src = `${baseLink}/static/data/${username}/images/auto_sklearn/auroc.png`
...
<h1>Classification Model: Auto-Sklearn</h1>
