					...
					<div class="hero bg-base-200 h-96">
						...
						<div class="hero-content text-left text-neutral-content">
							<div class="max-w-md">
								...
								<p class="mb-5">
									由于不同特征的数据的尺度、范围不同，为了消除特征的不齐性，我们需要将数据作标准化处理，使其scale到均值为0，方差为1的分布。
								</p>
								<button class="btn btn-primary" on:click={handleZscoreData}
									>使用Z-Score标准化</button
								>
							</div>
						</div>
					...
					<div class="hero bg-base-200 h-96">
						...
						<div class="hero-content text-left text-neutral-content">
							<div class="max-w-md">
								...
								<p class="mb-5">
									对于机器学习模型而言，我们必须为每一个特征赋上值，因此需要作补全处理。常用的补全方式有：均值填充以及中位数填充。
								</p>
								<div class="flex items-end justify-between px-4 pt-4 items-center">
									<select
										class="select select-bordered w-30 text-zinc-900"
										bind:value={selectedFillOption}
									>
					...
					<div class="hero bg-base-200 h-96">
						...
						<div class="hero-content text-left text-neutral-content">
							<div class="max-w-md">
								...
								<p class="mb-5">
									很多时候，数据中会出现异常分布，极大或极小，这通常是因为错误输入等原因导致。我们可根据Z-Score值的大小作筛选。(为了筛选效果，至少为2)
								</p>
								...
								<div class="flex items-end justify-between px-4 pt-4 items-center">
									<input
										...
										min="2"
										placeholder="输入阈值"
										class="input input-bordered input-primary text-zinc-900"
										bind:value={filterBar}
									/>
					...
					<div class="hero bg-base-200 h-96">
						...
						<div class="hero-content text-left text-neutral-content">
							<div class="max-w-md">
								...
								<p class="mb-5">
									我们为您提供了当前位置所有数据处理部分的代码，以Python Jupyter
									Notebook的形式呈现，便于您的调试。
								</p>
